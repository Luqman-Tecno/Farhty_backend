...
return [
    ...
    */
    ...
    'gt' => [
        ...
        'string' => 'الـ :attribute يجب ان يكون اكبر من :value حروفٍ/.',
    ],
    'gte' => [
        ...
        'string' => 'الـ :attribute يجب ان يكون اكبر من او يساوي :value حروفٍ/.',
    ],
    ...
    'lt' => [
        ...
        'string' => 'الـ :attribute يجب ان يكون اقل من :value حروفٍ.',
    ],
    'lte' => [
        'array' => 'الـ :attribute يجب ان يحتوي علي اكثر من :value عناصرعنصر.',
        'file' => 'الـ :attribute يجب ان يكون اقل من او يساوي :value كيلو بايت.',
        'numeric' => 'الـ :attribute يجب ان يكون اقل من او يساوي :value.',
        'string' => 'الـ :attribute يجب ان يكون اقل من او يساوي :value حروفٍ.',
    ],
    'mac_address' => 'يجب أن يكون الحقل :attribute عنوان MAC ذا بنية صحيحة.',
    'max' => [
        'array' => 'يجب أن لا يحتوي الحقل :attribute على أكثر من :max عناصرعنصر.',
        'file' => 'يجب أن لا يتجاوز حجم الملف :attribute :max كيلوبايت',
        'numeric' => 'يجب أن تكون قيمة حقل :attribute مساوية أو أصغر من :max.',
        'string' => 'يجب أن لا يتجاوز طول نص :attribute :max حروفٍ',
    ],
    ...
    'required_if' => 'الحقل :attribute مطلوب في حال ما إذا كان :other تساوي :value.',
    ...
    'size' => [
        ...
        'string' => 'يجب أن يحتوي النص :attribute على :size حروفٍ بالظبط',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'link'                  => ' ',
        'currency_id' => "العملة",
        'currency_uuid' => "العملة",
        'year' => "السنة",
        'country_id' => 'البلد',
        'agency_type_id' => 'نوع الهيئه',
        "meeting_attachment" => "محضر الإجتماع",
        'amount'                  => 'القيمة المدفوعة',
        'rejection_reason' => "سبب الرفض",
        'PAY' => "دفع",
        'REJECTED' => "مرفوض",
        "image" => "الصورة",
        "representatives" => "الممثلين عن الجهة",
        ...
        'annual_subscription_date' => 'تاريخ الإشتراك السنوي',
        'accrual_period' => 'مدة الإشتراك',
        'icon_image' => 'صورة الآيقونة',
        'jop_description' => 'الوصف الوظيفي',
        'folder_name' => 'اسم الملف ',
        'display_pos.mobile' => 'حالة عرض الهاتف ',
        'redirect_to' => 'التوجيه الي ',
        'sort' => 'الترتيب ',
        'color' => 'الون ',
    ...
    'values' => [
        'status' =>  [
            ...
            'DRAFT' => 'مسودة',
            'PAY' => "دفع",
            'ADJUSTABLE_REJECTION' => "رفض قابل للتعديل",
